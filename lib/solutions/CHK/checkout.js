...
module.exports = function (skus) {
    ...
    for (let i = 0; i < allDiscountOrders.length; i++) {
        ...
        let newTotal = total;
        let countOfEachSku = JSON.parse(JSON.stringify(mainDiscountedAppliedForSku));
        ...
        for (const sku in discountOrder) {
            ...
            newTotal = calculateBestDiscount(newTotal, countOfEachSku, discounts, sku, discountedAppliedForSku);
        }
