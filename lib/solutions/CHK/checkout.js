...
const calculatePriceAfterDiscount = (total, countOfEachSku, discount, SKU) => {
    ...
    if (discount.hasOwnProperty("free")) {
        ...
        if (numberOfDiscounts > 0) {
            ...
            console.log("Free item: ", freeItem["sku"])
            console.log("Number of free items to deduct: ", numberOfFreeItemsToDeduct);
            console.log("Amount to deduct: ", priceTable[freeItem["sku"]] * numberOfFreeItemsToDeduct);
