...
const {priceTable, discountTable, templateDiscountedAppliedForSku} = require('../../data/index');

const {getAllDiscountOrders, getMinMaxDiscount, calculateBestDiscount} = require('../../functions/index');
