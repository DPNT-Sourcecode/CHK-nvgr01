...
const { calculateBestDiscount, initializeObjectFromArray } = require('../../functions/index');
...
module.exports = function (skus) {
    ...
    let discountedAppliedForSku = initializeObjectFromArray(skusArray, false);
    ...
    for (const sku in discountTable) {
        // Check if the sku is in the skusArray
        ...
        console.log("sku", sku);
        let totalAfterDiscount = calculateBestDiscount(total, mainCountOfEachSku, discounts, sku, discountedAppliedForSku);
